        ...
        <div class="d-flex justify-content-center mt-5">
            <img src="/img/logos/logo4.png" v-bind:style="'width:' + $parent.windowWidth * 0.8 + 'px'">
                    ...
                    <div>
                        <div class="d-flex justify-content-center">
                            <div style="width:95%">
                                ...
                                <label class="mt-1 darkColour my-3" style="font-size:14px;">{{$store.getters.getDeliveryInfo.destination}}</label>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            <div style="width:95%">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <p class="my-0 darkColour" style="font-size:12px;color:#49915c">{{$store.getters.getDeliveryInfo.deliveryFee}}</p>
                                </div>
                                <div class="d-flex justify-content-start">
                                    <i class="far fa-clock my-auto  mr-2 my-auto darkColour" style="align-items:baseline;font-size:12px;color:#49915c"></i>
                                    <p class=" my-auto darkColour" style="font-size:12px;color:#49915c">{{$store.getters.getDeliveryInfo.duration.humanReadable}}</p>
                                </div>
                    ...
                    <div class="d-flex justify-content-between m-1">
                        ...
                        <div>
                            <div class="d-flex my-auto locationButton" style="height:100%;" v-on:click="requestLocation()">
                                <i class="fas fa-map-marker-alt my-auto mx-2 darkColour"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-5 mb-2">
                    <div style="width:80%">
                        <div class="darkBackground p-2 rounded my-2" v-if="$store.getters.getDeliveryInfo.destination" v-on:click="setMode('delivery');$router.push({name: 'home', params: {orderMode: mode}})">
