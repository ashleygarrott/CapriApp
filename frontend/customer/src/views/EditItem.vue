<template>
  <div >
    <v-app>
      ...
      <img v-bind:src="'/img/menus/' + menu.src" style="width: 100%; border-radius: 0% 0% 5% 5%;object-fit:cover" v-bind:style="'height:' + ($parent.screenHeight * 0.25) + 'px'">
      <div class="whiteCard p-2">
        <div class="row">
          <div class="col-8">
            <p class="darkgreyColour mt-0 mb-0 mr-2" style="font-size: 20px;"><b>{{menu.name}}</b></p>
          </div>
      ...
      <div class="mx-3" v-if="menu.addOns.length > 0">
          <p class="optionTitle"><b>Add ons</b></p>
      ...
      <div class="whiteCard my-1 p-2">
        <div class="mx-2">
          ...
          <div class="form-group">
            ...
            <div class="row mx-2">
              <small class="form-text text-muted mt-3">You may specify additional dietary requirements here</small>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row m-2" >
          ...
          <div class="col-8 p-0">
            <div class="d-flex ml-3">
              <div v-if="!addedToCart" class="rounded mediumBackground d-flex justify-content-center" style="width:100%" v-on:click="addToCart()">
                <p class="my-2  " style="color:white">Add to cart - {{finalPrice}}</p>
              </div>
              <div v-if="addedToCart" class="rounded d-flex justify-content-center" style="width:100%;background-color:lightgrey">
                <p class="my-2" style="color:white">Added to cart</p>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    created() {
        ...
        window.console.log("id: " + this.menuId)
        var item = this.$parent.orders[this.index]
    ...
    methods: {
      ...
      addToCart() {
        ...
        this.$parent.orders[this.index] = item
        window.localStorage.setItem("orders", JSON.stringify(this.$parent.orders))
