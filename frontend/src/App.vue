<template>
  <div id="app" class="d-flex flex-column h-100">
    ...
    <footer class="bg-light text-center p-1 fixed-bottom">
...
.preview-iframe-wrapper {
  ...
  .preview-iframe-wrapper .preview-hero-area {
    ...
    .preview-iframe-wrapper .preview-hero-area::after {
      position: absolute;
      content: "";
      background-image: url(/src/img/core-img/curve.png);
      bottom: 50px;
      width: 142px;
      height: 121px;
      background-repeat: no-repeat;
    ...
    .preview-iframe-wrapper .preview-hero-area .preview-content-wrapper {
      ...
      .preview-iframe-wrapper .preview-hero-area .preview-content-wrapper .qr-code-wrapper {
        ...
        .preview-iframe-wrapper .preview-hero-area .preview-content-wrapper .qr-code-wrapper::after {
          ...
          width: 200px;
          height: 200px;
          background-image: url(/src/img/core-img/dot-blue.png);
...
.sidenav-profile {
  ...
  .sidenav-profile .user-profile {
    ...
    .sidenav-profile .user-profile::before {
      ...
      top: -15px;
      left: -15px;
      background-image: url(/src/img/core-img/dot.png);
      content: "";
      z-index: -10;
      opacity: 0.2;
      border-radius: 50%; }
...
[data-theme="dark"] {
  ...
  [data-theme="dark"] .product-title-meta-data::after {
    background-image: url(/src/img/core-img/curve2.png); }
